...
$$
\varphi(\boldsymbol{x}) \ge \varphi(\boldsymbol{x}^*) + \frac{\mu}{2}\|\boldsymbol{x}-\boldsymbol{x}^*\|_2^2, \quad \forall\boldsymbol{x}\in\Omega
$$
...
!!! remarks "Proof"
    ...
    $$
    \varphi(\boldsymbol{x})= \tilde{\varphi}(\boldsymbol{x})+ \frac{\mu}{2}\|\boldsymbol{x}-\boldsymbol{x}^*\|_2^2
    $$
    ...
    $$
    \varphi(\boldsymbol{x}^*)
    \le \varphi(\boldsymbol{x}_t)= \tilde{\varphi}(\boldsymbol{x}_t)+ \frac{\mu}{2}\|\boldsymbol{x}_t - \boldsymbol{x}^*\|_2^2
    \le t\tilde{\varphi}(\boldsymbol{x})+ \bar{t}\tilde{\varphi}(\boldsymbol{x}^*)+ \frac{\mu t^2}{2}\|\boldsymbol{x}-\boldsymbol{x}^*\|_2^2
    $$

    Then

    $$
    \tilde{\varphi}(\boldsymbol{x})\ge \varphi(\boldsymbol{x}^*)- \frac{\mu t}{2}\|\boldsymbol{x}-\boldsymbol{x}^*\|_2^{2},\ 
    \forall t\in[0,1]\implies
